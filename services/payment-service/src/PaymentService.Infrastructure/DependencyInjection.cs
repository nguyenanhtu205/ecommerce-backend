...
public static class DependencyInjection
{
    public static void AddInfrastructureServices(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IOutboxMessageDispatcher, OutboxMessageDispatcher<PaymentRedirectCreated>>();
        builder.Services.AddScoped<IOutboxMessageDispatcher, OutboxMessageDispatcher<VnPayPaymentConfirmed>>();

        builder.Services.AddHostedService<OutboxDispatcherBackgroundService<ApplicationDbContext>>();
        
        builder.Services.AddSingleton(TimeProvider.System);

        builder.Services.AddHostedService<EscrowAutoReleaseJob>();
    }
}
